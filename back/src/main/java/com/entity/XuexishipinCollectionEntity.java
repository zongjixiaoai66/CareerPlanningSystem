...
public class XuexishipinCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public XuexishipinCollectionEntity() {

	}

	public XuexishipinCollectionEntity(T t) {
		try {
    ...
    @TableField(value = "xuexishipin_collection_types")
    ...
    public String toString() {
        return "XuexishipinCollection{" +
            ", id=" + id +
            ", xuexishipinId=" + xuexishipinId +
            ", yonghuId=" + yonghuId +
            ", xuexishipinCollectionTypes=" + xuexishipinCollectionTypes +
