...
public class ZhiyejieshaoView extends ZhiyejieshaoEntity implements Serializable {
	...
	*/
	...
	public ZhiyejieshaoView() {

	}

	public ZhiyejieshaoView(ZhiyejieshaoEntity zhiyejieshaoEntity) {
		try {
			BeanUtils.copyProperties(this, zhiyejieshaoEntity);
