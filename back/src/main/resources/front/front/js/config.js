...
var centerMenu = [
    ...
    ,{
        name: '课程收藏',
        url: '../xuexishipinCollection/list.html'
    }
    ,{
        name: '职业介绍收藏',
        url: '../zhiyejieshaoCollection/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '职业介绍',
        url: './pages/zhiyejieshao/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/itzhiyeshengyaguihua/admin/dist/index.html#/login";
