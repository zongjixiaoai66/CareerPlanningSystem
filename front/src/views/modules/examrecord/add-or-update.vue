    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="答题时长(分钟)" prop="exampaperDate">
                        <el-input v-model="exampaperForm.exampaperDate"
                                  placeholder="答题时长(分钟)" clearable  :readonly="ro.exampaperDate" readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="答题时长(分钟)" prop="exampaperDate">
                            <el-input v-model="ruleForm.exampaperDate"
                                      placeholder="答题时长(分钟)" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="答题编号" prop="examrecordUuidNumber">
                        <el-input v-model="ruleForm.examrecordUuidNumber"
                                  placeholder="答题编号" clearable  :readonly="ro.examrecordUuidNumber"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="答题编号" prop="examrecordUuidNumber">
                            <el-input v-model="ruleForm.examrecordUuidNumber"
                                      placeholder="答题编号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
    ...
    export default {
        data() {
            ...
            return {
                ...
                rules: {
                    examrecordUuidNumber: [
                        { required: true, message: '答题编号不能为空', trigger: 'blur' },
                    ],
                    yonghuId: [
                        { required: true, message: '答题用户不能为空', trigger: 'blur' },
                    ],
                    exampaperId: [
